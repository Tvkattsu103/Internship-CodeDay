...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<!--/.row-->
		<%
			ArrayList<ItemBean> lsLoai = ItemDao.getItemBook();
		%>

		<div class="container" style="padding-bottom: 50px">
			<div style="min-height: 78vh">
				<h2 style="color: green; font-weight: bold; margin-left: 150px;">
					<%=request.getAttribute("msg") != null ? request.getAttribute("msg") : ""%>
				</h2>
				<form action="UpLoadBookServlet" method="post"
					enctype="multipart/form-data">
					<table>

						<tr>
							<td><label for="name">Tên sách: </label></td>
							<td><input style="margin-bottom:5px" type="text" name="tensach" id="tensach" required></td>
						</tr>
						<tr>
							<td><label for="price">Giá:</label></td>
							<td><input style="margin-bottom:5px" type="number" name="gia" id="gia" required>
							</td>
						</tr>
						<tr>
							...
							<td><select style="display: block !important; margin-bottom:5px;"
								class="form-control" name="maloai">
									...
									%><option value="<%=l.getIteambookid()%>"><%=l.getName()%></option>
									<%
										}
									%>
							</select></td>
						...
						<tr>
							...
							<td><input style="margin-bottom:5px" type="text" name="tacgia" id="tacgia" required></td>
						</tr>
						<tr>
							<td><label for="star">Số lượng: </label></td>
							<td><input style="margin-bottom:5px" type="number" min="1" max="1000" name="soluong"
								id="soluong" required></td>
						</tr>
						<tr>
							<td><label for="image">Ảnh: </label></td>
							<td><input style="margin-bottom:5px" type="file" name="photo" id="photo" required>
							</td>
						</tr>
						<tr>
					...
					<button style="margin-left: 350px; margin-top: 10px;"
						class="btn btn-info" type="submit">Thêm sách</button>
				</form>
			</div>
		</div>
